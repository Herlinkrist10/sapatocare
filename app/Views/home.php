				...
				<div class="vertical-middle">
					<div class="container py-5">
						<div class="emphasis-title dark m-0">
							...
							<h1 style="font-size: 50px; line-height: 1.4; font-weight: 600; text-shadow: 1px 1px 1px rgba(0,0,0,0.5);">SAPATO CARE</h1><br>
							<p class="font-weight-light d-none d-md-block" style="font-size: 20px; opacity: 1;">"Sapato Care" adalah toko pembersih sepatu yang menyediakan<br> layanan pembersihan dan restorasi sepatu profesional. Dengan tim ahli yang <br> terampil dan peralatan canggih, Sapato Care memastikan sepatu Anda <br> mendapatkan perawatan dan perhatian terbaik yang layak mereka dapatkan.</p>
				...
				<div class="section m-0 clearfix" style="background-color: #eef2f5;">
					<div class="container clearfix">
						...
						<div class="heading-block center border-bottom-0 bottommargin topmargin-sm mx-auto" style="max-width: 640px">
							<h3 class="nott font-secondary font-weight-normal" style="font-size: 36px;">Apa yang kita lakukan?</h3>
							<span>Sapato Care melayani berbagai jenis sepatu, menawarkan solusi pembersihan yang dipersonalisasi untuk memenuhi kebutuhan khusus Anda. Percayakan kepada Sapato Care untuk menghidupkan sepatu Anda, memperpanjang usianya, dan menjaganya tetap segar dan murni.</span>
						</div>
