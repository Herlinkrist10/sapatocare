			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="<?= base_url('') ?>" class="standard-logo" data-dark-logo="<?= base_url() ?>demos/pet/images/logo-dark.png"><img src="<?= base_url('demos/pet/images/logo.png') ?>" alt="Canvas Logo"></a>
						</div><!-- #logo end -->	
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-left">
							Copyrights &copy; 2023 All Rights Reserved by Sapato Care.<br>
						</div>
