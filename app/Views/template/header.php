			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="<?= base_url('home/index') ?>" class="standard-logo" data-dark-logo="<?= base_url('demos/pet/images/logo-dark.png') ?>"><img src="<?= base_url('demos/pet/images/logo.png') ?>" alt="Canvas Logo"></a>
							<a href="<?= base_url('home/index') ?>" class="retina-logo" data-dark-logo="<?= base_url('demos/pet/images/logo-dark@2x.png') ?>"><img src="<?= base_url('demos/pet/images/logo@2x.png') ?>" alt="Canvas Logo"></a>
						</div><!-- #logo end -->	
